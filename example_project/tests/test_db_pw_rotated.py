...
class TestDbPwRotated(TransactionTestCase):
    ...
    def setUp(self):
        with connection.cursor() as cur:
            ...
            cur.execute(f"GRANT ALL PRIVILEGES ON DATABASE {settings.DATABASES['default']['NAME']} TO {self.rotate_pw_username};")
            cur.execute(f"GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE {Post._meta.db_table} TO {self.rotate_pw_username};")
